...
def generate_trace_id_v4_from_otel_trace_id(otel_trace_id: int, location: str) -> str:
    ...
    """
    # Inline construct_trace_id_v4 to avoid function call overhead in this hotspot.
    # The following produces: f"{TRACE_ID_V4_PREFIX}{location}/{trace_id}"
    return f"{TRACE_ID_V4_PREFIX}{location}/{encode_trace_id(otel_trace_id)}"
